...
public:
    ...
    void SetLowerValue(int aLowerValue, bool emitSig = true);

    int GetUpperValue() const;
    void SetUpperValue(int aUpperValue, bool emitSig = true);
...
signals:
	...
	void lowerChandedFinished(int aLowerValue);
	void upperChandedFinished(int aUpperValue);
