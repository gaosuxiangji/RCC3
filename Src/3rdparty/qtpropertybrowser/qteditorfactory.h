...
class QFixSpinBox : public QSpinBox
{
	Q_OBJECT
public:
	explicit QFixSpinBox(QWidget *parent = Q_NULLPTR);
	~QFixSpinBox();
...
class QtUserType_FileNameFactory :public QtAbstractEditorFactory<QtUserType_FileNameManager>
{
	Q_OBJECT
